...
## Task Status
- 🟠 ROP-001 - **welcome-to-rop** _(In Progress)_ Initial setup and docs.
- 🟠 ROP-002 - **style-hn** _(In Progress)_ Communication standards and HN post.
- 🟡 ROP-003 - **diagnostic-reviews** _(Pending)_ ROP/HROP critique collection.
- 🟢 ROP-004 - **diagnostic-fluff** _(Finished)_ Signal-to-noise ratio analysis.
